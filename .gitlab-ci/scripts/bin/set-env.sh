...
echo "CIPHERGUARD_FLAVOUR=${version_config[1]}"
echo "FILTER=${version_config[2]}"
echo "CIPHERGUARD_COMPONENT=${version_config[3]}"

export API_CLONE_BRANCH="${version_config[0]}"
export CIPHERGUARD_FLAVOUR="${version_config[1]}"
export FILTER="${version_config[2]}"
export CIPHERGUARD_COMPONENT="${version_config[3]}"
