...
class ResourcesUpdateNotificationWithStaticFixturesTest extends AppIntegrationTestCase
{
    ...
    public function testResourcesUpdateNotificationSuccess_Secrets(): void
    {
        ...
        $this->assertEmailInBatchContains('edited the password', 'ada@cipherguard.github.io');
        $this->assertEmailInBatchContains('edited the password', 'betty@cipherguard.github.io');
        $this->assertEmailInBatchContains('edited the password', 'carol@cipherguard.github.io');
        $this->assertEmailInBatchContains('edited the password', 'dame@cipherguard.github.io');
    }
}
